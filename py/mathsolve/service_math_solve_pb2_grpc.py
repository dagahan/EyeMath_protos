...
def add_GRPC_math_solveServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Metadata': grpc.unary_unary_rpc_method_handler(
                    servicer.Metadata,
                    request_deserializer=service__math__solve__pb2.MetadataRequest.FromString,
                    response_serializer=service__math__solve__pb2.MetadataResponse.SerializeToString,
            ),
            'Solve': grpc.unary_unary_rpc_method_handler(
                    servicer.Solve,
                    request_deserializer=service__math__solve__pb2.SolveRequest.FromString,
                    response_serializer=service__math__solve__pb2.SolveResponse.SerializeToString,
            ),
    }
